...
<template>
  <svg v-bind="$attrs" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
    <foreignObject width="100%" height="100%" x="0" y="0" externalResourcesRequired="true">
      <div
        ...
        style="
          ...
          block-size: 600px;
          border-block: 0px solid rgb(229, 231, 235);
          ...
          border-image: none;
          border-inline: 0px solid rgb(229, 231, 235);
          ...
          column-fill: balance;
          gap: normal;
          column-rule: 0px none rgba(48, 48, 48, 0.8);
          column-span: none;
          contain: none;
          ...
          flood-opacity: 1;
          font:
            15.9px / 24px __Space_Grotesk_0aa4ae,
      ...
      >
        <div
          style="
            background: linear-gradient(45deg, rgb(0, 97, 255) 0%, rgb(96, 239, 255) 100%);
            ...
            transform: none;
            transform-box: view-box;
            transform-origin: 255px 255px 0px;
            transform-style: flat;
            transition: all;
            translate: none;
            unicode-bidi: isolate;
